...
public class ControlTienda {
    ...
    public void stock(){
        mallaVista.agregarCarta(new Carta("60", "Charizard", "Fuego", "Legendaria", 260, 200, 220, "/imagenes/charizard.png", 120.0, true,10));
        mallaVista.agregarCarta(new Carta("61", "Blastoise", "Agua", "Ultra Rara", 230, 210, 240, "/imagenes/blastoise.png", 110.0, true,10));
        mallaVista.agregarCarta(new Carta("62", "Venusaur", "Planta", "Ultra Rara", 220, 200, 230, "/imagenes/venusaur.png", 105.0, true,10));
        mallaVista.agregarCarta(new Carta("63", "Pikachu", "Electrico", "Rara", 150, 100, 120, "/imagenes/pikachu.png", 60.0, true,10));
        mallaVista.agregarCarta(new Carta("64", "Gengar", "Fantasma", "Rara", 210, 150, 180, "/imagenes/gengar.png", 90.0, true,10));
